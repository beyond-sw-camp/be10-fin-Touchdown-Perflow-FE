...
<template>
  <Alert :model-value=successModalVisible message="직책 등록 성공!" @update:modelValue="updateSuccessModalVisible"/>
  <Alert :model-value=failModalVisible message="직책 등록 중 오류가 발생했습니다." @update:modelValue="updateFailModalVisible"/>
