...
const fetchKpiList = async (empId) => {
  try {
    const response = (await api.get(`/leader/perfomances/kpi/team/${empId}`)).data;
...
const addKPIdata = async (empId) => {
  ...
  try {
    const response = (await api.post(`/leader/perfomances/kpi/team/${empId}`, addKPI)).data;
...
const updateKPIdata = async (kpiId) => {
  ...
  try {
    const response = (await api.put(`/leader/perfomances/kpi/team/${kpiId}`, updatedKPI)).data;
...
const deleteKPIdate = async (kpiId, empId) => {
  try {
    const response = (await api.delete(`/leader/perfomances/kpi/team/${kpiId}/${empId}`)).data;
